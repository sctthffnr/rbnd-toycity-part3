...
puts 'Added features'
puts '-' * 50
puts "Return the nanoblock product"
puts walter.return(nanoblock)
puts 'Number of nanoblock items now in stock'
puts nanoblock.stock # Should return 10, since the product was returned
puts '-' * 50
puts "Walter Latimer's Transactions"
puts Transaction.find_by_customer('Walter Latimer') #
puts '-' * 50
puts 'Transactions involving Nano Block Empire State Building'
puts Transaction.find_by_product('Nano Block Empire State Building')
